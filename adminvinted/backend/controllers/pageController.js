...
export const createPage = async (req, res) => {
    try {
        ...
        const page = new Page({ title, slug, content, isActive, seo_title, seo_description, seo_keywords });
...
export const updatePage = async (req, res) => {
    try {
        ...
        const updatedPage = await Page.findByIdAndUpdate(
            req.params.id,
            { title, slug, content, isActive, seo_title, seo_description, seo_keywords },
