                ...
                <div style={{ background: 'white', borderBottom: '1px solid #e2e8f0', padding: '32px 0 24px', marginBottom: '40px' }}>
                    <Container fluid className="px-md-5 px-3">
                        <div className="d-flex align-items-center gap-2 mb-2" style={{ fontSize: '0.85rem' }}>
                            <div className="skeleton-box" style={{ width: '60px', height: '18px', borderRadius: '4px', backgroundColor: '#f1f5f9' }}></div>
                            <span style={{ color: '#94a3b8' }}>/</span>
                            <div className="skeleton-box" style={{ width: '100px', height: '18px', borderRadius: '4px', backgroundColor: '#f1f5f9' }}></div>
                            <span style={{ color: '#94a3b8' }}>/</span>
                            <div className="skeleton-box" style={{ width: '80px', height: '18px', borderRadius: '4px', backgroundColor: '#f1f5f9' }}></div>
                        </div>
                        <div className="d-flex align-items-center gap-4">
                            <div className="skeleton-box" style={{ width: '64px', height: '64px', borderRadius: '14px', flexShrink: 0, backgroundColor: '#f1f5f9' }}></div>
                            <div>
                                <div className="skeleton-box" style={{ width: '200px', height: '32px', borderRadius: '4px', marginBottom: '8px', backgroundColor: '#f1f5f9' }}></div>
                                <div className="skeleton-box" style={{ width: '300px', height: '20px', borderRadius: '4px', backgroundColor: '#f1f5f9' }}></div>
                            </div>
                        </div>
                    </Container>
                </div>
    ...
    if (!category) {
        return (
            <div className="d-flex flex-column justify-content-center align-items-center" style={{ minHeight: '60vh', gap: '16px' }}>
                ...
                <Link href="/categories" style={{ color: pc }}>Browse all categories</Link>
            </div>
        );
    }
            ...
            <Container fluid className="px-md-5 px-3">
                {allSubcategories.length === 0 ? (
                    <div className="text-center py-5">
                        ...
                        <button
                            onClick={() => router.push(`/categories/${slug}/all`)}
                            style={{
                        ...
                        <div className="vinted-category-grid">
                            ...
                            {subcategories.map(sub => (
                                <CategoryCard
                                    key={sub._id}
                                    item={sub}
                                    onClick={() => router.push(`/categories/${slug}/${sub.slug}`)}
                                    categoryImage={category.image}
                                    categoryIcon={category.icon}
                                />
                            ))}
