            ...
            <Container fluid className="px-md-5 px-3">
                <Row className="footer-top-row mb-5">
                    ...
                    <Col lg={4} md={12} className="mb-4 mb-lg-0">
                        <div className="footer-brand">
                            <Link href="/" className="footer-logo" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                {settings.site_logo ? (
                    ...
                    <Col lg={2} md={4} sm={6} className="mb-4 mb-md-0">
                        <div className="footer-col">
                            ...
                            <ul className="footer-links">
                                <li><Link href="/products">{t('footer.all_products', 'All Products')}</Link></li>
                                <li><Link href="/products?category=women">{t('footer.women', 'Women')}</Link></li>
                                <li><Link href="/products?category=men">{t('footer.men', 'Men')}</Link></li>
                                <li><Link href="/products?category=kids">{t('footer.kids', 'Kids')}</Link></li>
                                <li><Link href="/products?category=home">{t('footer.home', 'Home')}</Link></li>
                            </ul>
                        </div>
                    </Col>
                    ...
                    <Col lg={2} md={4} sm={6} className="mb-4 mb-md-0">
                        <div className="footer-col">
                            ...
                            <ul className="footer-links">
                                <li><Link href="/pages/help-center">{t('footer.help_center', 'Help Center')}</Link></li>
                                <li><Link href="/pages/shipping-info">{t('footer.shipping_info', 'Shipping Info')}</Link></li>
                                <li><Link href="/pages/returns-refunds">{t('footer.returns_refunds', 'Returns & Refunds')}</Link></li>
                                <li><Link href="/pages/item-verification">{t('footer.item_verification', 'Item Verification')}</Link></li>
                                <li><Link href="/contact">{t('footer.contact_us', 'Contact Us')}</Link></li>
                                <li><Link href="/pages/safety-center">{t('footer.safety_center', 'Safety Center')}</Link></li>
                            </ul>
                        </div>
                    </Col>
                ...
                <div className="footer-bottom">
                    ...
                    <div className="bottom-links">
                        <Link href="/pages/privacy-policy">{t('footer.privacy_policy', 'Privacy Policy')}</Link>
                        <Link href="/pages/terms-of-service">{t('footer.terms_of_service', 'Terms of Service')}</Link>
                        <Link href="/pages/cookie-settings">{t('footer.cookie_settings', 'Cookie Settings')}</Link>
                    </div>
                </div>
            </Container>
        </footer>
