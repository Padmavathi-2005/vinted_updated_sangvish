                ...
                <div className="dp-hero" style={{ 
                    ...
                    <div className="dp-hero-content">
                        <nav className="dp-breadcrumb">
                            <Link to="/" className="dp-bc-link">Home</Link>
                            <span className="dp-bc-sep">›</span>
                            <span className="dp-bc-current">{page.title}</span>
                        </nav>
                        <h1 className="dp-hero-title">{page.title}</h1>
