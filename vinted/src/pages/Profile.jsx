...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if (targetTab !== urlTab || targetMode !== urlMode) {
            navigate(`/profile?tab=${targetTab}&mode=${targetMode}`, { replace: true });
        }

        // 4. Always persist valid tab
        localStorage.setItem('profileActiveTab', targetTab);
    }, [urlTab, urlMode, mode, navigate, activeTab, setMode]);
    ...
    return (
        <div className="profile-dashboard">
            ...
            <div className="pd-container" key={location.search}>
                {/* ─── Top Navigation ─── */}
                        ...
                        <div className="pd-section-card pd-listings-container">
                            <div className="pd-section-header mb-4">
                                ...
                                <div className="d-flex gap-2 align-items-center">
                                    ...
                                    <Link to="/sell" className="btn btn-primary btn-sm px-3 d-flex align-items-center gap-2">
                            ...
                            <div className="vinted-product-grid mb-4" style={{ minHeight: '300px' }}>
                                {listingsLoading && myListings.length === 0 ? (
                                    ...
                                    <div className="w-100 pd-empty-state-full" style={{ gridColumn: '1 / -1', border: 'none' }}>
                                        ...
                                        <Link to="/sell" className="btn btn-primary rounded-pill px-4 fw-bold">{t('profile.start_selling_now', 'Start Selling Now')}</Link>
                                    </div>
                                )}
                            </div>
